...
Public Class CNPrintDebitRP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DPSReporting.CNPrintDebitRP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCNPrintDebitRP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CNPrintDebitRP = New CNPrintDebitRP
        rpt.Site = Me.Site
        Return rpt
    End Function
