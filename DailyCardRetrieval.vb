...
Public Class DailyCardRetrieval
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DPSReporting.DailyCardRetrieval.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDailyCardRetrieval
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DailyCardRetrieval = New DailyCardRetrieval
        rpt.Site = Me.Site
        Return rpt
    End Function
