Public Class frmCourierRpt
    ...
    Private Sub btnGetReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetReport.Click
        ...
        szFileName = BankInfo.Folder_Report & "CourierReport.rpt"
        ...
        '    dwOption = 3
        '    szFileName = BankInfo.Folder_Report & "CourierUpgrade.rpt"
        'End If
        ...
        Try
            ...
            szSQL = "EXEC sp_extractdata " & CStr(dwOption) & ",'" & cbFileDate.SelectedItem.ToString & "','" & gszStationId & "'"
            dwReturnRow = ExecuteSQL(szSQL)

            UpdateAuditLog("Print Courier Report for filetype[" & CStr(dwOption) & "] and filedate[" & cbFileDate.SelectedItem.ToString & "]", "Production")
        ...
        Catch ex As System.Exception
            MessageBox.Show("frmCourierRpt_btnGetReport_Click: Exception-" & ex.Message)
        End Try

    End Sub

    Private Sub frmCourierRpt_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        UpdateAuditLog("Print Courier Report", "Audit Log")
