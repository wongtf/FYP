...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents txtFileTypeDef As System.Windows.Forms.TextBox
    Friend WithEvents Label14 As System.Windows.Forms.Label
    Friend WithEvents txtCardTypeDef As System.Windows.Forms.TextBox
    Friend WithEvents Label8 As System.Windows.Forms.Label
    Friend WithEvents Button1 As System.Windows.Forms.Button
    Friend WithEvents txtDC9K As System.Windows.Forms.TextBox
    Friend WithEvents Label6 As System.Windows.Forms.Label
    Friend WithEvents txtFileDateDef As System.Windows.Forms.TextBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtFileDateDef = New System.Windows.Forms.TextBox
        Me.Label15 = New System.Windows.Forms.Label
        Me.txtFileTypeDef = New System.Windows.Forms.TextBox
        Me.Label14 = New System.Windows.Forms.Label
        Me.txtCardTypeDef = New System.Windows.Forms.TextBox
        ...
        Me.TreeView1.Size = New System.Drawing.Size(183, 534)
        ...
        Me.Panel1.Controls.Add(Me.txtFileDateDef)
        Me.Panel1.Controls.Add(Me.Label15)
        Me.Panel1.Controls.Add(Me.txtFileTypeDef)
        Me.Panel1.Controls.Add(Me.Label14)
        Me.Panel1.Controls.Add(Me.txtCardTypeDef)
        ...
        Me.Panel1.Size = New System.Drawing.Size(543, 517)
        Me.Panel1.TabIndex = 1
        '
        'txtFileDateDef
        '
        Me.txtFileDateDef.Location = New System.Drawing.Point(191, 316)
        Me.txtFileDateDef.MaxLength = 10
        Me.txtFileDateDef.Name = "txtFileDateDef"
        Me.txtFileDateDef.Size = New System.Drawing.Size(221, 21)
        Me.txtFileDateDef.TabIndex = 39
        '
        'Label15
        '
        ...
        Me.Label15.Size = New System.Drawing.Size(160, 37)
        Me.Label15.TabIndex = 40
        Me.Label15.Text = "FileDate Define (Start Position, Length) *"
        '
        'txtFileTypeDef
        '
        Me.txtFileTypeDef.Location = New System.Drawing.Point(191, 287)
        Me.txtFileTypeDef.MaxLength = 10
        Me.txtFileTypeDef.Name = "txtFileTypeDef"
        Me.txtFileTypeDef.Size = New System.Drawing.Size(221, 21)
        Me.txtFileTypeDef.TabIndex = 37
        '
        'Label14
        '
        Me.Label14.ForeColor = System.Drawing.Color.White
        Me.Label14.Location = New System.Drawing.Point(24, 283)
        Me.Label14.Name = "Label14"
        Me.Label14.Size = New System.Drawing.Size(160, 37)
        Me.Label14.TabIndex = 38
        Me.Label14.Text = "FileType Define (Start Position, Length) *"
        '
        'txtCardTypeDef
        '
        Me.txtCardTypeDef.Location = New System.Drawing.Point(191, 258)
        Me.txtCardTypeDef.MaxLength = 10
        Me.txtCardTypeDef.Name = "txtCardTypeDef"
        Me.txtCardTypeDef.Size = New System.Drawing.Size(221, 21)
        Me.txtCardTypeDef.TabIndex = 35
        '
        'Label8
        '
        ...
        Me.Label8.Text = "CardType Define (Start Position, Length) *"
        '
        'Button1
        '
        ...
        Me.Button1.Location = New System.Drawing.Point(486, 231)
        ...
        'txtDC9K
        '
        Me.txtDC9K.Location = New System.Drawing.Point(191, 229)
        ...
        'chkOutputFormat
        '
        Me.chkOutputFormat.Location = New System.Drawing.Point(191, 374)
        ...
        Me.btnBrowse4.Location = New System.Drawing.Point(486, 345)
        ...
        'txtLogo
        '
        Me.txtLogo.Location = New System.Drawing.Point(191, 345)
        ...
        Me.Label10.Location = New System.Drawing.Point(24, 349)
        ...
        Me.Label9.Location = New System.Drawing.Point(28, 467)
        ...
        Me.btnBrowse.Location = New System.Drawing.Point(486, 113)
        ...
        'GroupBox1
        '
        Me.GroupBox1.Location = New System.Drawing.Point(30, 435)
        ...
        Me.cbAlgorithm.Location = New System.Drawing.Point(191, 406)
        ...
        Me.btnCancel.Location = New System.Drawing.Point(387, 471)
        ...
        Me.btnSave.Location = New System.Drawing.Point(301, 471)
        ...
        Me.Label4.Location = New System.Drawing.Point(24, 407)
        ...
        Me.ClientSize = New System.Drawing.Size(725, 562)
...
#End Region
    ...
    Private Sub RefreshInformation(ByVal szId As String)
        ...
        Try
            ...
            While datareader.Read()
                ...
                txtCardTypeDef.Text = IIf(IsDBNull(datareader("conv_cardtypedef")), "", datareader("conv_cardtypedef"))
                txtFileTypeDef.Text = IIf(IsDBNull(datareader("conv_filetypedef")), "", datareader("conv_filetypedef"))
                txtFileDateDef.Text = IIf(IsDBNull(datareader("conv_filedatedef")), "", datareader("conv_filedatedef"))
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            ErrorProvider1.SetError(txtCardTypeDef, "")
            ErrorProvider1.SetError(txtFileTypeDef, "")
            ErrorProvider1.SetError(txtFileDateDef, "")
            ...
            If (txtCardTypeDef.Text = "") Then
                ErrorProvider1.SetError(txtCardTypeDef, "CardType Definition cannot be blank.")
                Exit Sub
            End If

            If (txtFileTypeDef.Text = "") Then
                ErrorProvider1.SetError(txtFileTypeDef, "FileType Definition cannot be blank.")
                Exit Sub
            End If

            If (txtFileDateDef.Text = "") Then
                ErrorProvider1.SetError(txtFileDateDef, "FileDate Definition cannot be blank.")
                Exit Sub
            End If
            ...
            Dim szConvCardTypeDef As String
            Dim szConvFileTypeDef As String
            Dim szConvFileDateDef As String
            ...
            szConvCardTypeDef = txtCardTypeDef.Text
            szConvFileTypeDef = txtFileTypeDef.Text
            szConvFileDateDef = txtFileDateDef.Text
            ...
            If (szId = NEW_ID) Then
                ...
                myCmd.CommandText = "INSERT INTO Bank (bank_name, bank_bin, bank_algorithm, bank_folder, bank_folder_input, bank_folder_output, bank_folder_backup, bank_folder_dc9K, conv_cardtypedef, conv_filetypedef, conv_filedatedef, bank_logo, bank_encrypted) VALUES ('" & _
                                    szBankName & "','" & szBIN & "'," & dwAlgorithm & ",'" & szRoot & "','" & szInput & "','" & szOutput & "','" & szBackup & "','" & szDC9K & "', '" & szConvCardTypeDef & "', '" & szConvFileTypeDef & "', '" & szConvFileDateDef & "', '" & szLogo & "'," & dwOutputEncrypted & ")"
            Else
                myCmd.CommandText = "UPDATE Bank SET bank_name='" & szBankName & "', bank_bin='" & szBIN & "', bank_algorithm=" & dwAlgorithm & ", bank_folder='" & szRoot & "', bank_folder_input='" & szInput & "', bank_folder_output='" & szOutput & _
                                    "', bank_folder_backup='" & szBackup & "', bank_folder_dc9k='" & szDC9K & "', conv_cardtypedef='" & szConvCardTypeDef & "', conv_filetypedef='" & szConvFileTypeDef & "', conv_filedatedef='" & szConvFileDateDef & "', bank_logo='" & szLogo & "', bank_encrypted=" & dwOutputEncrypted & " WHERE bank_id =" & szId
            End If
    ...
    Private Sub btnBrowse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrowse.Click
        ...
        Try
            FolderBrowserDialog.Description = "Please select the root folder for the bank."
            If (txtRoot.Text = "") Then
                FolderBrowserDialog.SelectedPath = gszWorkDrive
            Else
                If (IsFolderExist(txtRoot.Text) = True) Then
                    FolderBrowserDialog.SelectedPath = txtRoot.Text
                End If
            End If

            If (FolderBrowserDialog.ShowDialog() = Windows.Forms.DialogResult.OK) Then
                'txtRoot.Text = FolderBrowserDialog.SelectedPath
                txtRoot.Text = IIf(Microsoft.VisualBasic.Right(FolderBrowserDialog.SelectedPath, 1) = "\", FolderBrowserDialog.SelectedPath, FolderBrowserDialog.SelectedPath & "\")
                boolChanged = True
            End If
    ...
    Private Sub btnBrowse1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrowse1.Click
        ...
        Try
            FolderBrowserDialog.Description = "Please select the input folder for the bank."
            If (txtInput.Text = "") Then
                FolderBrowserDialog.SelectedPath = gszWorkDrive
            Else
                If (IsFolderExist(txtInput.Text) = True) Then
                    FolderBrowserDialog.SelectedPath = txtInput.Text
                End If
            End If

            If (FolderBrowserDialog.ShowDialog() = Windows.Forms.DialogResult.OK) Then
                'txtInput.Text = FolderBrowserDialog.SelectedPath
                txtInput.Text = IIf(Microsoft.VisualBasic.Right(FolderBrowserDialog.SelectedPath, 1) = "\", FolderBrowserDialog.SelectedPath, FolderBrowserDialog.SelectedPath & "\")
                boolChanged = True
            End If

        Catch ex As Exception
            MessageBox.Show("frmBank_btnBrowse2_Click: Exception-" & ex.Message)
        End Try
    ...
    Private Sub btnBrowse2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrowse2.Click
        ...
        Try
            FolderBrowserDialog.Description = "Please select the output folder for the bank."
            If (txtOutput.Text = "") Then
                FolderBrowserDialog.SelectedPath = gszWorkDrive
            Else
                If (IsFolderExist(txtOutput.Text) = True) Then
            ...
            If (FolderBrowserDialog.ShowDialog() = Windows.Forms.DialogResult.OK) Then
                ...
                txtOutput.Text = IIf(Microsoft.VisualBasic.Right(FolderBrowserDialog.SelectedPath, 1) = "\", FolderBrowserDialog.SelectedPath, FolderBrowserDialog.SelectedPath & "\")
                boolChanged = True
            End If
    ...
    Private Sub btnBrowse3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrowse3.Click
        ...
        Try
            FolderBrowserDialog.Description = "Please select the backup folder for the bank."
            If (txtBackup.Text = "") Then
                FolderBrowserDialog.SelectedPath = gszWorkDrive
            Else
                If (IsFolderExist(txtBackup.Text) = True) Then
                    FolderBrowserDialog.SelectedPath = txtBackup.Text
                End If
            End If

            If (FolderBrowserDialog.ShowDialog() = Windows.Forms.DialogResult.OK) Then
                'txtBackup.Text = FolderBrowserDialog.SelectedPath
                txtBackup.Text = IIf(Microsoft.VisualBasic.Right(FolderBrowserDialog.SelectedPath, 1) = "\", FolderBrowserDialog.SelectedPath, FolderBrowserDialog.SelectedPath & "\")
                boolChanged = True
            End If

        Catch ex As Exception
            MessageBox.Show("frmBank_btnBrowse3_Click: Exception-" & ex.Message)
        End Try
