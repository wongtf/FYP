...
Public Class ConversionRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DPSReporting.ConversionRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConversionRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConversionRep = New ConversionRep
        rpt.Site = Me.Site
        Return rpt
    End Function
