...
Public Class RenewalCardRetrieval
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RenewalCardRetrieval.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRenewalCardRetrieval
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RenewalCardRetrieval = New RenewalCardRetrieval
        rpt.Site = Me.Site
        Return rpt
    End Function
