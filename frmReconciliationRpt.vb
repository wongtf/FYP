Public Class frmReconciliationRpt
    ...
    Private Sub btnGetReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetReport.Click
        ...
        szFileName = BankInfo.Folder_Report & "ReconReport.rpt"
        ...
        Try
            ...
            szSQL = "EXEC sp_moveolddata '" & cbFileDate.SelectedItem.ToString & "'"
            dwReturnRow = ExecuteSQL(szSQL)

            szSQL = "EXEC sp_extractrecon " & CStr(dwOption) & ",'" & cbFileDate.SelectedItem.ToString & "','" & gszStationId & "'"
            dwReturnRow = ExecuteSQL(szSQL)

            UpdateAuditLog("Print reconciliation Report for filetype[" & CStr(dwOption) & "] and filedate[" & cbFileDate.SelectedItem.ToString & "]", "Production")
        ...
        Catch ex As System.Exception
            MessageBox.Show("frmReconciliationRpt_btnGetReport_Click: Exception-" & ex.Message)
        End Try

    End Sub

    Private Sub frmReconciliationRpt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        UpdateAuditLog("Print Reconciliation Report", "Audit Log")
