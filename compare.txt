Public Class frmMissingEmbossRpt
    ...
    Private Sub btnGetReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetReport.Click
        ...
        szFileName = BankInfo.Folder_Report & "missingEmboss.rpt"
        ...
        '    dwOption = 3
        '    szFileName = BankInfo.Folder_Report & "missingupgrade.rpt"
        'End If
        ...
        Try
            ...
            szSQL = "EXEC sp_extractmissingemboss " & CStr(dwOption) & ",'" & cbFileDate.SelectedItem.ToString & "','" & gszStationId & "'"
            dwReturnRow = ExecuteSQL(szSQL)

            UpdateAuditLog("Print Missing Embossing Report for filetype[" & CStr(dwOption) & " and filedate[" & cbFileDate.SelectedItem.ToString & "]", "Production")
            ...
            Dim strSQL As String = "Select * From TempMissing Where StationId='" & gszStationId & "'"
            Dim DA As New OleDb.OleDbDataAdapter(strSQL, myconn)
            Dim DS As New DataSet

            DA.Fill(DS, "TempMissing")
            objReport.SetDataSource(DS.Tables("TempMissing"))
        ...
        Catch ex As System.Exception
            MessageBox.Show("frmMissingEmbossRpt_btnGetReport_Click: Exception-" & ex.Message)
        End Try

    End Sub

    Private Sub frmEmbossRpt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        UpdateAuditLog("Print Missing Embossing Report", "Audit Log")
