...
Public Class ErrConversionRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DPSReporting.ErrConversionRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedErrConversionRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ErrConversionRep = New ErrConversionRep
        rpt.Site = Me.Site
        Return rpt
    End Function
