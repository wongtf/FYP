...
Public Class MissingEmboss
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DPSReporting.MissingEmboss.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMissingEmboss
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MissingEmboss = New MissingEmboss
        rpt.Site = Me.Site
        Return rpt
    End Function
