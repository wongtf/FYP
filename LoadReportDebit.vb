...
Public Class LoadReportDebit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DPSReporting.LoadReportDebit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLoadReportDebit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LoadReportDebit = New LoadReportDebit
        rpt.Site = Me.Site
        Return rpt
    End Function
