...
Public Class MECardRetrieval
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DPSReporting.MECardRetrieval.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMECardRetrieval
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MECardRetrieval = New MECardRetrieval
        rpt.Site = Me.Site
        Return rpt
    End Function
